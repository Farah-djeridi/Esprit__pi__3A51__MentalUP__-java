...
public class ControllerAdminUsers {
    ...
    private VBox createUserCard(User user) {
        ...
        editBtn.setOnAction(e -> openUserForm(user));
        ...
        resetBtn.setStyle("-fx-background-color: #FFF3E0; -fx-text-fill: #E67E22; " +
                ...
                "-fx-background-radius: 8; -fx-padding: 6 12; -fx-font-size: 12px; -fx-cursor: hand;");
        resetBtn.setOnAction(e -> resetPassword(user));
    ...
    @FXML public void onAddUser() { openUserForm(null); }
    ...
    @FXML public void goToStats() { SceneManager.switchTo("StatsAdmin.fxml", "Statistiques"); }
    ...
    @FXML public void onHoverEnter(javafx.scene.input.MouseEvent e) {
        javafx.scene.layout.HBox h = (javafx.scene.layout.HBox) e.getSource();
