...
public class ServiceSujet implements IService<Sujet> {
    ...
    public void add(Sujet s) {
        ...
        try {
            ...
            pstm.setInt(6, getCurrentUserId()); // Utilisateur ID 2
            ...
            System.out.println("Sujet ajouté par l'utilisateur ID: " + getCurrentUserId());
    ...
    public void delete(Sujet s) {
        deleteSujetWithCheck(s, getCurrentUserId());
    }
